...
# Enter the input data file name through console and read the data using pandas
data = input("Enter the input File Name: ")

if os.path.exists(data):
    freader = pd.read_csv(data)
elif IOError:
    print "\nUnable to open file: "+str(data)
